/*
    ...
    DUAL 테이블
    1. DUMMY 칼럼 1개 + 'X' 값을 1개 가지고 있는 테이블이다 ====> 칼럼 이름이 DUMMY
    2. 아무 일도 안하는 테이블이다.
...
-- 이때 자동으로 TO_NUMBER 함수가 사용된다

SELECT EMPLOYEE_ID, FIRST_NAME, LAST_NAME
  FROM EMPLOYEES
 WHERE EMPLOYEE_ID = '150'; --EMPLOYEE_ID = TO_NUMBER('150')으로 자동으로 변환한 뒤 처리한다 원래는 안된다..
        --숫자       --문자        // 숫자 문자 동등 비교 연산
...
-- 3. 날짜로 변환하기(TO_DATE)
-- 날짜와 시간을 원하는 형식을 표시하는 함수가 아님을 주의하십시오
